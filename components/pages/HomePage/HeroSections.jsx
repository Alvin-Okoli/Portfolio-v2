    ...
    <div className="w-full h-fit flex flex-col justify-center items-start gap-5">
      <div className="w-full flex flex-col justify-start items-start">
        <AnimateContent idx={1}>
          <h1 className="md:text-[42px] text-[24px] font-semibold text-text-primary font-heading leading-tight tracking-tighter">
            Hi, I&apos;m {CMS.FirstName}
          </h1>
        </AnimateContent>

        <AnimateContent idx={2}>
          <p className="md:text-[42px] text-[24px] leading-tight tracking-tighter text-pretty font-semibold text-text-secondary font-">
