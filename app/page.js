...
export default async function Home({ searchParams }) {
  ...
  return (
    <div className="w-full px-4 py-4 gap-4 h-screen  flex md:flex-row flex-col justify-end items-center relative font-body">
      ...
      <div className="md:w-[60%] w-full md:h-full h-[60%] flex flex-col gap-4">
